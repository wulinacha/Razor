...
{
    internal class PropertyNode : RQNameNode
    {
        public PropertyNode(AggregateNode aggregate, SymbolNameNode symbolName, TypeVariableCountNode typeVariableCount, ParametersNode parameters)
        {
            Aggregate = aggregate;
